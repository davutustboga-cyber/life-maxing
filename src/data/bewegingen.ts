...
export const bewegingen: Beweging[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────────
  {
    ...
    script:
      "Ga zitten of liggen. Span steeds één spiergroep zo'n vijf tellen aan, en laat daarna helemaal los — voel bewust het verschil. Begin bij je voeten en kuiten. Dan je bovenbenen en billen. Dan je buik. Dan je handen en armen. Dan je schouders, naar je oren toe. Eindig met je gezicht: ogen dicht, kaak los. Adem gewoon door terwijl je aanspant.",
    herkomst: [
      {
        label: "W",
        regel:
          "Een overzicht van 46 publicaties bij meer dan 3.400 volwassenen (Muhammad Khir e.a., 2024) vond dat progressieve spierontspanning stress, angst en somberheid verminderde; hoe lang (5 tot 28 minuten) en hoe vaak mensen oefenden maakte daarbij geen duidelijk verschil. Eerlijke nuance: het is een overzicht zonder samengevoegd effectcijfer, van onderzoeken van wisselende kwaliteit (ook zonder gerandomiseerde controlegroep) — een goede aanwijzing dat het vaak helpt, geen garantie.",
      },
    ],
    ...
    herkomst: [
      {
        label: "P",
        regel:
          "Je aandacht richten op wat je nu concreet waarneemt is een veelgebruikte manier om uit piekeren of een overweldigd gevoel te stappen, en veel mensen ervaren het als kalmerend. Dat is ervaring uit de praktijk, niet iets waar hier gecontroleerd onderzoek onder ligt. Het staat hier omdat het weinig kost en weinig kan misgaan.",
      },
    ],
    ...
    herkomst: [
      {
        label: "P",
        regel:
          "Je aandacht bewust naar het contact met de grond brengen is een eenvoudige, snel uit te voeren vorm van grounding die veel gebruikt wordt bij een overweldigd gevoel. Er ligt hier geen apart onderzoek onder; het staat hier omdat het snel gaat en weinig kan misgaan.",
      },
    ],
    ...
    herkomst: [
      {
        label: "P",
        regel:
          "Een gedachte benoemen als \"ik heb de gedachte dat...\" komt uit de ACT-traditie (cognitieve defusie): je kijkt naar de gedachte in plaats van er vanuit te redeneren. Er wordt onderzoek gedaan naar defusie in het algemeen, maar dit zinnetje zelf is hier niet apart nagelopen. Het staat hier omdat het voor veel mensen een gedachte iets minder vast laat voelen.",
      },
    ],
    ...
    herkomst: [
      {
        label: "P",
        regel:
          "Een gedachte voorstellen als iets dat voorbijdrijft — een wolk, een blaadje op water — is een standaardoefening uit de ACT-traditie (cognitieve defusie). Deze specifieke oefening is hier niet apart onderzocht. Het werkt waarschijnlijk het best als losse oefening op een rustig moment, niet als noodgreep midden in een crisis.",
      },
    ],
