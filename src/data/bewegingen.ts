...
import type { Beweging } from "../lib/types.js";

export const bewegingen: Beweging[] = [
  {
    ...
    script:
      "Adem een paar keer wat langer uit dan in. Vier tellen in, zes tellen uit. Twee minuten, niet langer.",
    herkomst: [
      {
        label: "W",
        ...
        regel:
          "Rustig ademen met een langere uitademing heeft een bescheiden maar consistent, direct voelbaar kalmerend effect, in meerdere gecontroleerde onderzoeken teruggevonden — en scoorde in een directe vergelijking op stemming beter dan even lang mediteren.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Iets in woorden vastleggen vermindert in herhaald onderzoek de lichamelijke onrust die een gevoel met zich meebrengt — het werkt het best als je erna ook kiest wat je ermee doet, niet als eindpunt op zich.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Iets goeds doen voor een ander verhoogt aantoonbaar je eigen welbevinden — in een groot gecontroleerd onderzoek verlaagde vriendelijkheid naar anderen toe depressie, angst én eenzaamheid, via het gevoel van verbondenheid.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Schrijf op wat er blijft rondspoken — kort, geen analyse. Kies dan een moment vandaag waarop je het weer oppakt. Tot dan mag het hier blijven liggen.",
    herkomst: [
      {
        label: "W",
        regel:
          "Ergens anders naar leren kijken werkt over allerlei culturen heen beter dan een gevoel wegduwen — maar pas als de eerste onrust al wat gezakt is, en dat is precies waarom dit hier pas als tweede stap komt.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Mild zijn voor jezelf na een misstap verlaagt zelfkritiek met een middelgroot effect, en werkt in onderzoek beter dan streng voor jezelf zijn.",
      },
      {
        label: "I",
        regel:
          "Sluit aan bij tawba: opnieuw beginnen zonder jezelf te veroordelen — apart van de wetenschappelijke reden hierboven, nooit ermee vermengd.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Bewust een minuut blijven stilstaan bij iets goeds bouwt in onderzoek merkbaar duurzamere veerkracht op — een van de best herhaalde bevindingen binnen de positieve psychologie.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Dankbaarheid uiten hangt in onderzoek over allerlei culturen samen met meer welbevinden, en specifiek met minder somberheid en angst.",
      },
      {
        label: "I",
        regel:
          "Sluit aan bij shukr — dankbaarheid als aanbidding, niet alleen als techniek voor een beter gevoel. Zie de aparte beweging hieronder voor die islamitische vorm; dit hier is de seculiere variant, gericht op een concreet persoon.",
      },
    ],
    ...
    herkomst: [
      {
        label: "W",
        regel:
          "Weer in contact komen met iets dat je uitstelt is een van de sterkst onderbouwde manieren om neerslachtigheid te doorbreken — het voelt zelden meteen prettig, en dat is hier ook niet het doel.",
      },
    ],
    ...
    herkomst: [
      {
        label: "I",
        regel:
          "Dankbaarheid als vorm van aanbidding, niet als techniek voor een beter gevoel — dit staat los van de wetenschappelijke dankbaarheidsbron bij de andere beweging hierboven, en wordt er nooit mee vermengd.",
      },
    ],
...

  {
    ...
    script:
      "Stel jezelf de vraag met je eigen naam erin, alsof je hem aan iemand anders stelt. Waar gaat dit eigenlijk over? Voelt dat te gek? Neem dan de tijd in plaats van de naam: hoe kijk je hier over een jaar op terug?",
    herkomst: [
      {
        label: "W",
        regel:
          "Je eigen naam gebruiken in plaats van 'ik' verlaagt aantoonbaar de spanning bij iets lastigs, en is een van de goedkoopste vormen van afstand nemen die er zijn — bijna moeiteloos. Bij schuld en schaamte werkt het duidelijk minder goed.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Schrijf op wat er gebeurd is — in feiten. Dan wat het je gekost heeft. En dan één zin: wat zou het schelen als je dit niet meer meedroeg? Dit gaat niet over contact opnemen en niet over goedpraten. Niet vergeven mag ook.",
    herkomst: [
      {
        label: "W",
        regel:
          "Vergevingsoefeningen verhogen vergeving en verbeteren somberheid, angst en hoop, over ruim vijftig onderzoeken heen — al werkten in datzelfde onderzoek langere programma's van uren tot weken beter. Wat hier staat is de eerste stap daaruit, niet het hele programma.",
      },
      {
        label: "I",
        regel:
          "Sluit aan bij ʿafw: kwijtschelden zonder dat de ander erom vraagt en zonder het onrecht goed te praten — apart van de wetenschappelijke reden hierboven, nooit ermee vermengd.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Ga even naar buiten en kijk omhoog. Helder of bewolkt maakt niet uit — het gaat om het omhoogkijken. Kan dat niet: een beeld van iets weids op je scherm doet hetzelfde werk.",
    herkomst: [
      {
        label: "W",
        regel:
          "Een korte ontzagoefening verlaagde in onderzoek stress en somberheid en verhoogde welbevinden — maar had geen enkel aantoonbaar effect op angst, en het bekende 'kleine zelf'-gevoel bleek in vervolgonderzoek maar inconsistent op te treden.",
      },
      {
        label: "I",
        regel:
          "Sluit aan bij tafakkur: kijken naar wat gemaakt is als vorm van bezinning — apart van de wetenschappelijke reden hierboven, nooit ermee vermengd.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Denk aan één iemand. Wat neem je aan dat hij of zij van jou vindt? En hoe zeker weet je dat eigenlijk? Eén ronde is genoeg — laat het hier, of stuur die persoon iets.",
    herkomst: [
      {
        label: "W",
        regel:
          "Vertekende sociale gedachten aanpakken kwam in vergelijkend onderzoek naar voren als de sterkste van vier aanpakken tegen eenzaamheid — al berust dat op maar drie kleine studies. Van de zeven nieuwe bewegingen is dit de zwakst onderbouwde.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Neem één vraag mee naar buiten en loop ermee. Niet erover redeneren — gewoon lopen, en de vraag laten meelopen. Het lopen doet het meeste werk.",
    herkomst: [
      {
        label: "W",
        regel:
          "Beweging gecombineerd met een psychologische oefening verslaat beweging alleen, met een groot effect op somberheid over achttien onderzoeken heen. Eerlijke nuance: de combinatie deed het niet aantoonbaar beter dan de psychologische oefening alléén — het lopen doet hier het werk, de vraag lift mee.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Loop, en laat één zin meelopen op je adem. Geen aantal, geen doel. Merk je dat je alleen nog aan het lopen bent, dan is dat ook goed.",
    herkomst: [
      {
        label: "W",
        regel:
          "Alleen over het lopen: beweging blijft een van de best onderbouwde hefbomen in deze bibliotheek, en gekoppeld aan iets anders werkt het beter dan beweging alleen. Wat er tijdens het lopen in je hoofd omgaat is in dit onderzoek nooit dhikr geweest — die koppeling is niet onderzocht.",
      },
      {
        label: "I",
        regel:
          "Dhikr als herinnering, meelopend op de adem, zonder aantal en zonder doel — apart van de wetenschappelijke reden hierboven, nooit ermee vermengd.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Beweeg — lopen, fietsen, de trap op. Houd één beeld vast van wie je aan het worden bent, en één ding dat daarbij in de weg staat. Het bewegen draagt het, niet andersom.",
    herkomst: [
      {
        label: "W",
        regel:
          "Beweging gekoppeld aan een psychologische oefening verslaat beweging alleen, en het beeldwerk hier — een beeld van wat je wilt naast het obstakel dat ertussen staat — is dezelfde oefening als in het weekmoment, maar dan lopend. Die twee zijn nooit samen onderzocht: de losse delen staan stevig, de combinatie is een redenering.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────────────────────
  {
    ...
    script:
      "Vier tellen in, vier tellen vasthouden, vier tellen uit, vier tellen vasthouden. Het scherm telt vanzelf mee.",
    herkomst: [
      {
        label: "W",
        regel:
  ...
  },
  {
    ...
    script:
      "Twee keer achter elkaar inademen door je neus — een gewone teug, en daarbovenop nog een klein slokje lucht. Dan lang en langzaam uitademen door je mond.",
    herkomst: [
      {
        label: "W",
        regel:
          "Twee korte inademingen na elkaar, gevolgd door een lange, langzame uitademing, verlaagde in een gecontroleerd onderzoek de spanning sneller dan gewoon rustig ademen of mindfulness — al bij één keer, en het effect was sterker naarmate mensen het vaker herhaalden over een paar weken.",
      },
    ],
    ...
    herkomst: [
      {
        label: "P",
        regel:
          "Bouwt voort op hetzelfde effect als een langere uitademing (zie 'Ademen met lange uitademing'), met een oplopende telling die voor sommigen makkelijker vast te houden is dan vrij ademen. Dit precieze ritme zelf is niet apart onderzocht.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────────────────────
  {
    ...
    script:
      "Noem, hardop of in je hoofd: vijf dingen die je ziet. Vier dingen die je voelt — je kleren, de stoel, de lucht. Drie dingen die je hoort. Twee dingen die je ruikt. Eén ding dat je proeft.",
    herkomst: [
      {
        label: "W",
        regel:
          "Aandacht sturen naar wat je nu concreet waarneemt via je zintuigen is een veelgebruikte, goed verdraagbare manier om uit piekeren of een overweldigd gevoel te stappen — het onderbreekt de aandacht die anders bij de gedachte zelf zou blijven hangen.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Ga zitten of staan. Voel je voeten echt op de grond — het gewicht, de temperatuur, de druk. Duw ze een paar tellen tegen de vloer. Adem gewoon door.",
    herkomst: [
      {
        label: "W",
        regel:
          "Aandacht bewust naar lichamelijke waarneming verplaatsen — het contact met de grond — is een basisvorm van grounding die snel uitvoerbaar is en breed gebruikt wordt bij een overweldigd gevoel, vooral in combinatie met de zintuigenoefening hierboven.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Neem de gedachte die blijft hangen. Zeg of schrijf hem opnieuw, maar begin met: 'Ik heb de gedachte dat...'. Dan nog een keer: 'Ik merk dat ik de gedachte heb dat...'. Niets aan de gedachte zelf veranderen — alleen hoe je ernaar kijkt.",
    herkomst: [
      {
        label: "W",
        regel:
          "Een gedachte herformuleren als iets dat je opmerkt, in plaats van als een feit, vermindert aantoonbaar hoe geloofwaardig en onaangenaam die gedachte aanvoelt — zonder de inhoud ervan te bestrijden of weg te duwen.",
      },
    ],
  ...
  },
  {
    ...
    script:
      "Stel je de gedachte voor als iets buiten jezelf — een wolk die voorbijdrijft, een blaadje op water, een zin op een lopende band. Je hoeft hem niet te geloven of te bestrijden, alleen te zien voorbijgaan.",
    herkomst: [
      {
        label: "W",
        regel:
          "Een gedachte visueel voorstellen als iets dat langsdrijft, in plaats van iets dat je bent, is een kernoefening uit cognitieve-defusietraining en vermindert hoe vast gedachten blijven zitten — werkt het best als losse oefening op een rustig moment, niet als noodgreep midden in een crisis.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────────────────────
  {
    ...
    script:
      "Zet een tijd. Doe niets: geen telefoon, geen muziek, geen lezen. Kijk naar iets stils — een muur, het plafond, buiten. Verveling die opkomt hoeft niet weg.",
    herkomst: [
      {
        label: "W",
        regel:
          "Aanhoudende korte prikkels, vooral van een scherm, maken langzame, rustige aandacht lastiger vast te houden. Jezelf bewust en herhaald blootstellen aan verveling zonder een prikkel te pakken, hangt samen met minder verlangen naar diezelfde snelle prikkels en meer verdragen van niets-doen. Het is ongemakkelijk vóór het went — dat ongemak is het punt, niet een teken dat het niet werkt.",
      },
    ],
...
export function bewegingById(id: string): Beweging | undefined {
