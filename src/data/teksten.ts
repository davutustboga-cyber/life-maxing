...
export const teksten = {
  ...
  kompas: {
    ...
    tijdOpties: [
      { label: "twee minuten", waarde: "2min" as const },
      { label: "tien minuten", waarde: "10min_of_meer" as const },
      { label: "meer dan dat", waarde: "10min_of_meer" as const },
      { label: "geen idee", waarde: "10min_of_meer" as const },
    ],
  ...
  afsluiten: {
    laatsteRegel: null as string | null,
  },
  deHemel: {
  ...
  weekmoment: {
    ...
    intro: {
      ...
      uitleg:
        "Waar je aandacht naartoe gaat en in welke innerlijke staat je verkeert, verandert wat je opmerkt, hoe je dingen uitlegt, wat je kiest en hoe je reageert — en dat verandert over tijd je leven. Wat wij hier níét beweren: dat gedachten rechtstreeks de fysieke wereld sturen.",
      begin: "Beginnen",
      nuNiet: "Nu niet",
    },
    herkomst: {
    ...
    schuldval:
      "Je doet de oorzaken; de uitkomst is niet aan jou. Als iets niet komt, betekent dat niet dat je niet genoeg geloofde. Dat is niet hoe het werkt, en het is ook niet wat tawakkul betekent.",
    schuldvalNeutraal:
      "Je doet de oorzaken; de uitkomst is niet aan jou. Als iets niet komt, betekent dat niet dat je niet genoeg je best deed.",
  ...
  onderbreker: {
    ...
    herkomst: {
      ...
      nadelen:
        "Langer doomscrollen hangt samen met een somberder stemming, meer piekeren en — vlak voor het slapen — een slechtere nachtrust. Het overprikkelt ook je aandacht, waardoor rustigere, echte dingen daarna juist moeilijker aanvoelen om aan te beginnen.",
  ...
  frictie: {
    ...
    intro:
      "Niet in de app, maar eromheen: vier manieren om jezelf iets meer wrijving te geven voordat het scrollen begint.",
    suggesties: [
