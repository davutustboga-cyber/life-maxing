...
export interface MotivatieQuote {
  /** In het Nederlands (v27); het origineel staat in `origineel`. */
  tekst: string;
  origineel?: string;
  auteur: string;
  bron?: string;
...
export interface ProfetenVerhaal {
  profeet: string;
  titel: string;
  tekst: string;
  bronnen: string[];
...
/** Samengesteld object voor één weergave — zie motivatiehoekVoorVandaag. */
export interface MotivatiehoekDag {
  quote: MotivatieQuote;
  verhaal: ProfetenVerhaal;
...
export const motivatieQuotes: MotivatieQuote[] = [
  {
...
// versnummer.
export const profetenVerhalen: ProfetenVerhaal[] = [
  {
