...
import type { LifeMaxingData, Weekmoment } from "./types.js";
 ...
 */
export function weekSleutel(nu = new Date()): string {
 ...
 */
export function weekmomentBeschikbaar(data: LifeMaxingData, nu = new Date()): boolean {
