...
export const STREKEN: Streek[] = ["lichaam", "geest", "verbinding", "ziel"];

export function sterrenVanStreek(sterren: Ster[], streek: Streek): Ster[] {
 ...
 */
export function aanbodVoorStreek(data: LifeMaxingData): Streek | null {
