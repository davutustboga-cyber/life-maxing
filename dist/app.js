        ...
        teksten.kompas.tijdOpties.map((opt) =>
          el(
            "button",
            {
              class: "knop",
              onclick: () => {
                if (huidigMoment) huidigMoment.tijdBeschikbaar = opt.waarde        ;
                void bewaren();
                toonS4();
              },
            },
...
function toonS23AvondSluiten()       {
  toonS23Stap1Kompas({ positie: null, chips: new Set        (), dankbaarheid: "", zin: "", voorMorgen: "" });
}
