...
export const adhkar = [
    {
        ...
        transliteratie: "Allahu la ilaha illa huwa, al-hayyu-l-qayyum, la ta'khudhuhu sinatun wa la nawm, lahu ma fis-samawati wa ma fil-ard, man dhal-ladhi yashfa'u 'indahu illa bi-idhnih, ya'lamu ma bayna aydihim wa ma khalfahum, wa la yuhituna bishay'im-min 'ilmihi illa bima sha'a, wasi'a kursiyyuhus-samawati wal-ard, wa la ya'uduhu hifdhuhuma, wa huwal-'aliyyul-'adhim.",
        vertaling: "Allah — er is geen god dan Hij, de Levende, de Onderhouder van alles. Sluimer noch slaap overmant Hem. Van Hem is wat in de hemelen en wat op de aarde is. Wie kan bij Hem bemiddelen zonder Zijn toestemming? Hij weet wat vóór hen is en wat na hen komt, en zij omvatten niets van Zijn kennis dan wat Hij wil. Zijn troon strekt zich uit over de hemelen en de aarde, en het behoeden ervan vermoeit Hem niet. En Hij is de Verhevene, de Geweldige.",
    ...
    },
    {
        ...
        arabisch: "اللَّهُمَّ أَنْتَ رَبِّي، لاَ إِلَهَ إِلاَّ أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَىَّ وَأَبُوءُ لَكَ بِذَنْبِي، فَاغْفِرْ لِي، فَإِنَّهُ لاَ يَغْفِرُ الذُّنُوبَ إِلاَّ أَنْتَ",
        transliteratie: "Allahumma anta rabbi, la ilaha illa anta, khalaqtani wa ana 'abduka, wa ana 'ala 'ahdika wa wa'dika mastata'tu, a'udhu bika min sharri ma sana'tu, abu'u laka bini'matika 'alayya, wa abu'u laka bidhanbi, faghfir li, fa innahu la yaghfiru adh-dhunuba illa anta.",
        vertaling: "O Allah, U bent mijn Heer, er is geen god dan U. U heeft mij geschapen en ik ben Uw dienaar, en ik houd mij aan Uw verbond en belofte zo goed ik kan. Ik zoek bescherming bij U tegen het kwaad dat ik heb gedaan. Ik erken Uw gunsten aan mij, en ik erken mijn zonde. Vergeef mij dan, want niemand vergeeft zonden behalve U.",
