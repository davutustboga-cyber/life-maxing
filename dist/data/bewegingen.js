...
export const bewegingen = [
    ...
    },
    {
        ...
        script: "Ga binnen het eerste uur na het wakker worden even naar buiten, of voor een raam zonder zonnebril. Geen minimum aantal minuten — het gaat om het moment, niet om de duur. Je telefoon mag nog even wachten.",
        herkomst: [
            {
                label: "W",
            ...
            {
                label: "P",
                regel: "De telefoon nog even laten liggen is een eigen idee: het houdt de eerste minuten waarschijnlijk rustiger, maar daar is geen onderzoek naar nagelopen.",
            },
        ],
    ...
    // ──────────────────────────────────────────────────────────────────────────────
    {
        ...
        herkomst: [
            {
                label: "W",
                regel: "In kleine onderzoeken maakten een paar uur weinig drinken mensen wat vermoeider en gespannener, en gaf iets drinken vooral meer gevoelde alertheid. Voor concentratie zijn de uitkomsten minder consistent. Water is prettig, goedkoop en risicoloos, maar geen sterke hefboom: een zacht begin, geen oplossing.",
            },
        ],
    ...
    },
    {
        ...
        script: "Sta op en loop een rondje door de kamer, of naar het raam. Rek je armen en schouders een paar keer uit. Ga weer verder wanneer het genoeg is.",
        herkomst: [
            {
                label: "W",
                regel: "De WHO adviseert lang stilzitten te beperken en te vervangen door beweging van elke intensiteit, ook rustig. Hoe vaak of hoe lang precies, is niet vast te stellen: daarvoor is er te weinig onderzoek. Dit is dus een richting, geen norm.",
            },
        ],
    ...
    },
    {
        ...
        script: "Zet je scherm op nachtstand, of zet de helderheid lager. Kies rustige dingen om naar te kijken, niets dat je opjaagt. Leg je telefoon daarna ergens neer waar je er niet zomaar bij kunt, niet naast je bed.",
        herkomst: [
            {
                label: "W",
                regel: "Schermgebruik vlak voor het slapen hangt in meerdere overzichtsstudies samen met later inslapen en korter slapen, vooral bij interactieve dingen zoals social media en games. Dat is een verband, geen bewezen oorzaak. Een blauwlichtfilter of nachtstand deed in gecontroleerde onderzoeken weinig of niets aantoonbaars voor de slaap: de meeste winst zit in het scherm eerder wegleggen, niet in de filter.",
            },
            {
                label: "P",
                regel: "De nachtstand staat hier voor wie toch nog op het scherm zit: zachter licht is prettiger voor je ogen. Dat is een eigen idee, geen belofte voor je slaap.",
            },
        ],
