...
const R = (c, x, y, w, h, rx = 0) => `<rect class="${c}" x="${x}" y="${y}" width="${w}" height="${h}"${rx ? ` rx="${rx}"` : ""}/>`;
const E = (c, cx, cy, rx, ry) => `<ellipse class="${c}" cx="${cx}" cy="${cy}" rx="${rx}" ry="${ry}"/>`;
const C = (c, cx, cy, r) => `<circle class="${c}" cx="${cx}" cy="${cy}" r="${r}"/>`;
const P = (c, d) => `<path class="${c}" d="${d}"/>`;
/** Een achtpuntige ster (geometrisch patroon), als pad. */
function ster8(cx, cy, groot, klein) {
    let d = "";
    for (let i = 0; i < 16; i++) {
...
function lichtsnoer(x0, y0, cx, cy, x1, y1, n) {
...
function boeken(x, plankY, hoogte, breedtes) {
    let s = "";
    let px = x;
...
function bouwAdem() {
    return {
        ...
        voorwerpen: [
            ...
            {
                i: 2,
                z: R("ks-a2", 198, 98, 124, 56, 12) + R("ks-a2", 190, 132, 140, 36, 9) + R("ks-a", 204, 106, 50, 26, 8) + R("ks-a", 266, 106, 50, 26, 8) +
                    R("ks-h2", 198, 166, 6, 8) + R("ks-h2", 316, 166, 6, 8),
            },
            {
                i: 5,
                z: R("ks-h", 38, 152, 70, 6, 2) + R("ks-h2", 46, 158, 5, 18) + R("ks-h2", 95, 158, 5, 18) + P("ks-a2", "M56 152c0-13 34-13 34 0z") +
                    E("ks-water", 73, 148, 14, 3) + E("ks-rimpel", 73, 148, 6, 1.6),
            },
            {
                i: 3,
                z: R("ks-h", 334, 152, 20, 20, 3) + P("ks-g", "M344 152C326 142 326 122 336 110C348 124 348 140 344 152Z") +
...
function bouwLichaam() {
    return {
        ...
        voorwerpen: [
            ...
            {
                i: 2,
                z: R("ks-h2", 20, 22, 7, 150, 2) + R("ks-h2", 74, 22, 7, 150, 2) +
            ...
            {
                i: 4,
                z: P("ks-a2", "M198 96h22a8 8 0 0 1 8 8v30h-38v-30a8 8 0 0 1 8-8z") + R("ks-h2", 200, 110, 26, 4, 1) + P("ks-h2", "M204 190h14v-10h10v16H204z"),
            },
            ...
            {
                i: 7,
                z: C("ks-wiel", 262, 150, 20) + C("ks-wiel", 332, 150, 20) +
...
function bouwMensen() {
    return {
        ...
        voorwerpen: [
            ...
            {
                i: 2,
                z: R("ks-h2", 78, 112, 5, 60) + R("ks-h", 78, 146, 30, 6, 2) + R("ks-h2", 80, 152, 5, 20) + R("ks-h2", 102, 152, 5, 20) +
            ...
            {
                i: 4,
                z: R("ks-h2", 200, 36, 26, 32, 2) + R("ks-a", 203, 39, 20, 26) + R("ks-h2", 110, 42, 30, 38, 2) + R("ks-a", 113, 45, 24, 32) +
...
function bouwVisie() {
    return {
        basis: R("ks-raam", 200, 18, 140, 112, 4) + C("ks-ster", 226, 40, 1.3) + C("ks-ster", 256, 62, 1) + C("ks-ster", 300, 36, 1.4) + C("ks-ster", 322, 66, 1) +
        ...
        voorwerpen: [
            {
                i: 0,
                z: R("ks-h2", 30, 34, 52, 66, 2) + R("ks-c", 35, 39, 42, 56) + P("ks-al", "M42 52H70M42 62H70M42 72H64") +
...
function bouwGeloof() {
    ...
    return {
        ...
        voorwerpen: [
            ...
            {
                i: 2,
                z: R("ks-h", 296, 34, 58, 138, 3) + R("ks-h2", 300, 74, 50, 3) + R("ks-h2", 300, 112, 50, 3) + R("ks-h2", 300, 148, 50, 3) +
...
function bouwMotivatie() {
    return {
        ...
        voorwerpen: [
            ...
            {
                i: 2,
                z: R("ks-h2", 24, 38, 58, 74, 3) + R("ks-c", 30, 46, 20, 20, 1) + R("ks-a2", 54, 50, 22, 16, 1) + R("ks-a", 32, 72, 24, 22, 1) + R("ks-c", 60, 76, 16, 26, 1),
            },
 ...
 * even op).
 */
export function kamerSceneSvg(id, aan, nieuw = null, hoog = false) {
    const bouw = BOUW[id]?.();
    if (!bouw)
        return "";
    const voorwerpen = bouw.voorwerpen
        ...
        .join("");
    return (`<svg class="ks-svg" viewBox="0 ${hoog ? -60 : 0} 360 ${hoog ? 320 : 220}" preserveAspectRatio="xMidYMid slice" role="img" aria-label="De kamer van binnen">` +
