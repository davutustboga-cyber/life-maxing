...
import { dagdeelVan, suggestiesVoorNu } from "./nu.js";
...
export function gevoelById(id) {
    return GEVOELENS.find((g) => g.id === id);
}
function zoneZin(zone) {
    switch (zone) {
        case "A_kalmeren":
...
function visieVeldVoorKamer(kamerId) {
    switch (kamerId) {
        case "lichaam":
        case "adem":
...
export function visieRegelVoorKamer(data, kamerId) {
    if (!data.visie)
        return null;
...
function bewegingVoorstel(id, reden) {
 ...
 */
export function adviesVoor(gevoelId, tijd, data, nu = new Date()) {
